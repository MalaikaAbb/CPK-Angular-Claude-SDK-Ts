...
- [Runnable headless example](/angular/claude-sdk-typescript/features#headless-simple)
- [Runnable multimodal example](/angular/claude-sdk-typescript/features#multimodal)
